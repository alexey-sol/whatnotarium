...
export const INCREMENT_VIEW_COUNT_FAILURE = `${POSTS} Increment View Count - ${FAILURE}`;
export const INCREMENT_VIEW_COUNT_START = `${POSTS} Increment View Count - ${START}`;
export const INCREMENT_VIEW_COUNT_SUCCESS = `${POSTS} Increment View Count - ${SUCCESS}`;
